      ...
      >
        ...
        <div className="p-5 border-b border-white/10 relative z-10 flex justify-between items-start">
          <div className="pr-4">
            ...
            <p className="text-blue-200 text-[10px] font-bold tracking-[0.2em] uppercase mt-1">PassNexus Verified</p>
          </div>
        ...
        <div className="py-2 text-center bg-black/60 relative z-10">
          <p className="text-white/30 text-[8px] font-black tracking-[0.3em] uppercase">PassNexus Security Protocol &middot; Secure Entry</p>
        </div>
      </div>
