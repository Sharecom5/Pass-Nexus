          ...
          {success ? (
            ...
            <>
              ...
              <div className="mt-8 flex items-center gap-4">
                ...
                <p className="text-[10px] uppercase tracking-widest font-black text-slate-400">or sign up with</p>
                <div className="flex-1 h-px bg-slate-100"></div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full mt-6 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 h-14 rounded-2xl font-bold flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70"
              >
